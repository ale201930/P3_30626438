...
const db = new sqlite3.Database('./db/databse.sqlite', () => {
    ...
    db.run('CREATE TABLE IF NOT EXISTS productos(id INTEGER PRIMARY KEY AUTOINCREMENT, nombre TEXT, codigo INTEGER NOT NULL, laboratorio TEXT, precio REAL NOT NULL, cantidad REAL NOT NULL, descripcion TEXT, categoria_id INTEGER, FOREIGN KEY(categoria_id) REFERENCES categorias(id))');
