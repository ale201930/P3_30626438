...
let consulta = {
    ...
    insertarProducto: 'INSERT INTO productos (nombre, codigo, laboratorio, precio, cantidad, descripcion, categoria_id) VALUES (?, ?, ?, ?, ?, ?, ?)',
    ...
    editarProducto: 'UPDATE productos SET nombre = ?, codigo = ?, laboratorio = ?, precio = ?, cantidad = ?, descripcion = ?, categoria_id = ? WHERE id = ?',
...
module.exports = {
    ...
    insertarProducto(nombre, codigo, laboratorio, precio, cantidad, descripcion, categoria_id){
        return new Promise ((resolve, reject) => {
            db.run(consulta.insertarProducto, [nombre, codigo, laboratorio, precio, cantidad, descripcion, categoria_id], (err) => {
                if (err) reject(err);
                resolve ();
            })
        })
    ...
    editarProducto( id, nombre, codigo, laboratorio, precio, cantidad, descripcion){
        return new Promise ((resolve, reject) => {
            db.run(consulta.editarProducto, [nombre, codigo, laboratorio, precio, cantidad, descripcion, id ], (err) => {
                if (err) reject(err);
                resolve ();
            })
        })
