...
router.post('/productos', (req, res) => {
  const { nombre, codigo, laboratorio, precio, cantidad, descripcion, categoria_id } = req.body;
  db.insertarProducto(nombre, codigo, laboratorio, precio, cantidad, descripcion, categoria_id); // Función que inserta el producto en la base de datos
...
router.post('/actualizar', (req, res) => {
  const id = req.params.id;
  const { nombre, codigo, laboratorio, precio, cantidad, descripcion} = req.body;
  db.editarProducto(id, nombre, codigo, laboratorio, precio, cantidad, descripcion); // Función que inserta el producto en la base de datos
